...
## 📋 Overview
The primary goal of the NFIRS data pipeline and analysis project is to implement efficient extract, load, transform (ELT) processes using an open-source modern data stack. The project also provides a high-level analysis on fire incidents throughout the U.S. in 2022. This project is designed to help professionals seeking to enhance their data ingestion and transformation workflows, ensuring complete and accurate data for analytical purposes.
...
Inspriration for this project was drawn from my time living in the mountains of northern California. Wildfires are something most east coasters do not experience regularly and moving to California was eye-opening in terms of understanding how at-risk the state is with wildfires, how frequently they occur, and how desctructive wildfires are for millions of people each year.
...
**Location**: [python_scripts](https://github.com/jaflores10/nfirs-data-pipeline/blob/main/nfirs_dbt/nfirs_dagster/nfirs_dagster/assets.py)
...
The dbt models are used to clean and transform the NFIRS data. Key transformations include changing data types and restructuring data to facilitate analysis and visualization.
...
- `models/`: Contains dbt models for various stages of data transformation cycle
